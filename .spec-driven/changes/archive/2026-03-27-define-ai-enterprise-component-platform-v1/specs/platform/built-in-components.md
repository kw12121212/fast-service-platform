# Built-In Components Delta

## ADDED Requirements

### Requirement: Minimum Enterprise Management Component Set
The system MUST provide user management, role-based permission management, software project management, ticket management, and kanban management as the minimum built-in component set for V1.

#### Scenario: A contributor checks the V1 baseline
